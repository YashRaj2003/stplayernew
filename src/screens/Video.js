...
const Videoplayer = () => {
    const [userData, setuserData] = useState({
        "_id": "whwvBRVPQrU8F8g6KDrU0BYN8mO2",
        "displayName": null,
        "email": null,
        "emailVerified": false,
        "isAnonymous": false,
        "phoneNumber": "+918210789094",
        "photoURL": null,
        "uid": "whwvBRVPQrU8F8g6KDrU0BYN8mO2",
        "metadata": {
            "createdAt": "1683540259206",
            "lastLoginAt": "1683540836952"
        },
        "id": "whwvBRVPQrU8F8g6KDrU0BYN8mO2"
    });
    const router = useRouter();
    const id = "mk3eGvK2H6Sols0Jso6f";
    ...
    let position = getMinutesfromsecond(currentTime);
    let Duration = getMinutesfromsecond(duration);
                        ...
                        <View style={{ padding: 25 }}>
                            ...
                            <View style={{ paddingVertical: 30, borderBottomColor: "#e3e3e3", borderBottomWidth: 1 }}>
                                <View style={{ width: "100%", flexDirection: "row", alignItems: "flex-start", justifyContent: "space-around", }}>
                                    <TouchableOpacity style={{ width: 73, height: 73, borderColor: "#e3e3e3", borderWidth: 2 }} onPress={() => router.push('/channel', { id: videoDetails?.channel?._id })}>
